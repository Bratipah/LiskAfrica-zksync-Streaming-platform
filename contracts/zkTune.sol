...
contract zkTune is Ownable {
    ...
    function getSongsStreamedByUser(address _user) external view returns (Song[] memory) {
        ...
        return usegit add contracts/SongNFT.sol contracts/zkTune.sol contracts/Paymaster.solrStreamedSongs; // Return the array
    }
}
git add contracts/SongNFT.sol contracts/zkTune.sol contracts/Paymaster.sol